...
import { Link } from 'react-router-dom'; // Assuming you are using react-router-dom for linking
            ...
            >
              ...
              <div className="w-[45%]">
                {item.book ? (
                  ...
                  <span className="text-red-500">Description unavailable</span>
                )}
              </div>
              <div className="w-[9%]">
                {item.book ? (
